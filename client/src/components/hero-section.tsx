    ...
    <section id="home" className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-white to-cyan-50 pt-16">
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          >
           I'm a passionate full-stack developer with over 5 years of hands on coding  and 2 year of professional experience building web applications and solving real-world problems.
          </motion.p>
